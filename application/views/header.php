            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                  ...
                  <h3 class="menu-title">Transaksi</h3>
                    ...
                    <li>
                        <a href="<?=base_url("purchase");?>"> <i class="menu-icon fa fa-shopping-cart"></i>Pemesanan Barang </a>
                    </li>
                    <li>
                  ...
                  <h3 class="menu-title">Data & Laporan</h3>
                    <li>
                        <a href="<?=base_url("pelanggan");?>"> <i class="menu-icon fa fa-user"></i>Data Pelanggan </a>
                    </li>
                    <li>
                        <a href="<?=base_url("karyawan");?>"> <i class="menu-icon fa fa-users"></i>Data Karyawan </a>
                    </li>
                    <li>
                        <a href="<?=base_url("sparepart");?>"> <i class="menu-icon fa fa-archive"></i>Data Barang </a>
                    </li>
                    <li>
                        <a href="<?=base_url("services");?>"> <i class="menu-icon fa fa-cogs"></i>Data Services </a>
                    </li>
                    <li>
                        <a href="<?=base_url("supplier");?>"> <i class="menu-icon fa fa-file"></i>Data Supplier </a>
                    </li>
                    ...
                    <li>
                        <a href="<?=base_url("report/purchase");?>"> <i class="menu-icon fa fa-bar-chart-o"></i>Laporan Pemesanan Barang</a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
