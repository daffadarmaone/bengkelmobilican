<div class="breadcrumbs">
        ...
        <div class="content mt-3">
            <div class="card">
                <div class="card-header">
                    <button type="button" class="btn btn-sm btn-success btn-add"><i class="fa fa-plus"></i> Tambah Pelanggan</button>
                </div>
            ...
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="largeModalLabel">Tambah Pelanggan</h5>
        ...
        <script>
            ...
            $("#data").DataTable({
                ...
                "autoWidth":true,
                "order": [],
                "ajax": {"url": "<?=base_url("pelanggan/json");?>"}
            });

            $(".btn-add").on("click",function() {
                jQuery("#compose .modal-title").html("Tambah Pelanggan");
                jQuery("#compose form").attr("action","<?=base_url("pelanggan/insert");?>");
            ...
            $("body").on("click",".btn-edit",function(){
                ...
                jQuery("#compose .modal-title").html("Edit Pelanggan");

                jQuery.getJSON("<?=base_url("pelanggan/get");?>/"+id,function(data){
                    jQuery("#compose form").attr("action","<?=base_url("pelanggan/edit");?>/"+id);
            ...
            function deleteData(id) {
                jQuery.getJSON("<?=base_url("pelanggan/delete");?>/"+id,function(data){
                    if(data.status) {
                        jQuery("#data").DataTable().ajax.reload(null,true);
